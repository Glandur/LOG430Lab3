...
public class ListDeliveriesMadeToDriver extends Communication {

	public ListDeliveriesMadeToDriver(Integer registrationNumber,
	...
	public void update(Observable thing, Object notificationNumber) {
		...
		if (registrationNumber.compareTo((Integer) notificationNumber) == 0) {
			 ...
			 */
			if (myDriver != null) {
				display.displayDeliveriesMadeToDriver(myDriver);
			} else {
				System.out.println("\n\n *** Driver not found ***");
			}
		}
