...
/**
 * Upon notification, lists the deliveries that were read into the vector stored in
...
public class ListDeliveries extends Communication {

	public ListDeliveries(Integer registrationNumber, String componentName) {
	...
	public void update(Observable thing, Object notificationNumber) {
		...
		if (registrationNumber.compareTo((Integer) notificationNumber) == 0) {
			...
			display.displayDeliveryList(CommonData.theListOfDeliveries
					.getListOfDeliveries());
		}
	}
}