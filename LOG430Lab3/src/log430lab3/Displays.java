...
public class Displays {
	...
	public void displayDeliveriesAssignedToDriver(Driver driver) {
        ...
        public void displayDeliveriesMadeToDriver(Driver driver) {

		boolean done;
		Delivery delivery;

		System.out.println("\nDeliveries made this week by : "
				+ driver.getFirstName() + " " + driver.getLastName() + " "
				+ driver.getDriverID());
		lineCheck(2);
		System.out
	...
	public void displayDeliveryList(DeliveryList list) {
        ...
        public void displayDeliveryNotAssigned(DeliveryList list) {
		...
		while (!done) {
			...
			if (delivery == null) {
                            ...
                            delivery.getDriversAssigned().goToFrontOfList();
                                if(delivery.getDriversAssigned().getNextDriver() == null)
                                {
                                    displayDelivery(delivery);
                                    lineCheck(1);
                                }
