...
public class Executive extends Communication {
	...
	public void execute() {
		...
		addToReceiverList("AssignDriverToDelivery");
                addToReceiverList("ListDeliveriesWeekComponent");
                addToReceiverList("ListDeliveriesNotAssignedComponent");
		...
		while (!done) {
			...
			case '5':
				...
				break;
                        ...
                        case '6':
				signalReceivers("ListDeliveriesWeekComponent");
				break;
                            
                        case '7':
				signalReceivers("ListDeliveriesNotAssignedComponent");
				break;    
